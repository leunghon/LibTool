...
class RecordFilter(django_filters.FilterSet):
	authorEnglish2 = CharFilter(label='Author Name (Eng)',field_name='authorEnglish2', lookup_expr='iexact',widget=forms.TextInput(attrs={"max_length":"100","style":"width:175px;margin-left:25px;margin-right:25px;margin-top:10px"}))
	authorKorean  = CharFilter(label='Author Name (Korean)',field_name='authorKorean', lookup_expr='iexact',widget=forms.TextInput(attrs={"max_length":"100","style":"width:175px;margin-left:25px;margin-right:25px;margin-top:10px"}))
	...
	publisher = CharFilter(label='Publisher',field_name='publisher', lookup_expr='icontains',widget=forms.TextInput(attrs={"max_length":"100","style":"margin-left:0px;margin-right:0px;margin-top:10px"}))
	...
	year  = NumberFilter(label='Published Year =',field_name='yearCreated', lookup_expr='icontains',widget=forms.TextInput(attrs={"max_length":"100","style":"width:175px;margin-left:25px;margin-right:25px;margin-top:10px"}))
	...
	class Meta:
		model = Record
		fields = ['authorEnglish2','authorKorean','workTitle', 'translator', 'sourceTitle', 'start_date', 'end_date', 'genre', 'year']
